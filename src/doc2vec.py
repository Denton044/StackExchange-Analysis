...
corpus = word_embedding_utils.get_text_data_test(fp)

#clean the loaded data
print("Cleaning corpus")
cleaned_corpus = word_embedding_utils.clean_corpus(corpus, stops)
...
w2id = word_embedding_utils.build_w2id_dict(cleaned_corpus, vocabulary_size)
idx2word = dict(zip(w2id.values(), w2id.keys()))
print("obtaining data_stream")
data_stream = word_embedding_utils.corpus_to_idx(cleaned_corpus, w2id)
...
doc_embeddings = tf.Variable(tf.random_uniform([len(data_stream), doc_embedding_size], -1.0, 1.0))
...
for i in range(generations):
    batch_inputs, batch_labels = word_embedding_utils.generate_batch_data(data_stream, batch_size,
